...
public class ContactManagerApp {
	...
	public static void main(String[] args) {
		...
		displayContacts(contactsNoPhoneNoEmail, "Contacts - no email and no phone");
		...
		MyConsole.printLine("Contacts names, again!!!");
		processContacts(contacts, c -> MyConsole.printLine(c.getName()));
		
		MyConsole.printHeader("Contact strings w/ default values if phone is null");
		...
		// BONUES: streams on arrays?? No - Convert Array to List first
		String[] names = {"Jim", "Jerry", "Heath", "Andy"};
...
//		namesList.forEach(n -> MyConsole.printLine(n));
		...
		// p. 555 map - reduce contacts to a single string in csv (comma seperated value) format
